...
add_action ( 'wishlistmember_approve_user_levels', array( &$twpw_custom_mc, 'acl_approve_user' ), 30, 2 );
add_action ( 'wishlistmember_add_user_levels', array( &$twpw_custom_mc, 'acl_approve_user' ), 30, 2 );
add_action ( 'wishlistmember_confirm_user_levels', array( &$twpw_custom_mc, 'acl_approve_user' ), 30, 2 );
add_action ( 'wishlistmember_uncancel_user_levels', array( &$twpw_custom_mc, 'acl_approve_user' ), 30, 2 );
